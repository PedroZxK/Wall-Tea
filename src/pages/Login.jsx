    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Importante: Armazenar o token e userId
                localStorage.setItem('token', data.token);  // Assumindo que o token vem na resposta
                localStorage.setItem('userId', String(data.usuario.id)); // Converter para string
        ...
        <>
            ...
            <CadastroContainer>
                <FormContainer>
                    ...
                    <form onSubmit={handleLogin}> {/* Adicionado o form e onSubmit */}
                        <InputGroup>
